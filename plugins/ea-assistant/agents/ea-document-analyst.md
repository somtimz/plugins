...
description: >
  Use this agent when the user uploads or references a document or diagram to be used as input to an EA engagement — including existing architecture documents, strategy papers, completed interview forms, requirements files, or uploaded diagrams. Examples:
