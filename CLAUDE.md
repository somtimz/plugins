...
- Markdown (Claude Code plugin command definitions) + Claude Code plugin framework, existing (001-ea-new-engagement-setup)
- JSON files (`engagement.json` per engagement), Markdown (001-ea-new-engagement-setup)
