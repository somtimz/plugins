...
1. **Load question bank.** Read `skills/ea-artifact-templates/references/phase-interview-questions.md`. Merge questions from Preliminary and Phase A into this sequence:
   ...
   - **Part 3 — Motivation** (Prelim Q12–17 + Phase A §4–§5/§7–§8/§10–§11): drivers (with evidence), vision, mission, goals (with rationale), objectives, strategies, issues (with evidence and raised-by), problems (with evidence and raised-by)
   - **Part 4 — Opportunities & Metrics** (Phase A §9): opportunities, success measures, baseline sources
   - **Part 5 — Programme & Risks** (Prelim Q18–20 + Phase A §2/§13–§14/§16): programme structure, timeline, constraints, assumptions, key risks
