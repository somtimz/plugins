...
- **Add success:** "G-NNN added to engagement.json. Run `/ea-goals generate` to refresh the Goals Register, and use '/ea-objectives add' to operationalise this goal with a measurable objective."
