...
| Display view | Architecture Vision `§4 Business Drivers` — columns `ID \| Driver \| Type \| Force \| Impact on Strategy \| Linked Goals \| Evidence / Source \| Details` ← `id, statement, type, —, —, linkedGoals, evidence` |
