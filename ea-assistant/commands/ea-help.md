...
| `/ea-matrix [list\|new\|show\|edit\|check] [key]` | TOGAF relationship matrices — 21 grid artifacts (Actor/Role, App/Data CRUD, Capability/Application, Goal/Service, Capability/Service, Rule/Service, Process/Value Stream, Use Case/Capability, Use Case/Process, Data Entity/Component, System/Technology…) with axis seeding and catalogue-driven checks | — |
...
| `/ea-meta [view\|edit\|raw]` | Full engagement.json record in one place — see every field grouped, edit metadata, or view the raw JSON | — |
| `/ea-help` | This guide | — |
