...
Score **authored** artifacts. This includes primary Phase artifacts such as `architecture-vision`, `business-model-canvas`, `business-architecture`, `operating-model`, `data-architecture`, `application-architecture`, `technology-architecture`, `gap-analysis-*`, `architecture-roadmap`, `statement-of-architecture-work`, `migration-plan`, `engagement-charter`, `governance-framework`, and `implementation-governance-plan`.
