...
**Current version:** 0.9.50 (plugin.json · docs/PRD.md)
...
42 commands available — run `/ea-help` for the full table with agent assignments.
Key entry points: `/ea-new` · `/ea-open` · `/ea-interview` · `/ea-grill` · `/ea-generate` · `/ea-status` · `/ea-brief` · `/ea-lens`
