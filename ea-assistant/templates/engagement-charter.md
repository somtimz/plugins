...
| Motivation chain completeness (DRV→G→OBJ) | ⚠️ Pending | |
| Stakeholder coverage | ⚠️ Pending | |
...
|---|---|---|---|---|---|---|
| [DRV-001](../details/DRV-001.md) | {{driver_description}} | External / Internal / Regulatory / Strategic | High / Medium / Low | {{notes}} | G-NNN | {{evidence_1}} |
| [DRV-002](../details/DRV-002.md) | {{driver_description}} | External / Internal / Regulatory / Strategic | High / Medium / Low | {{notes}} | G-NNN | {{evidence_2}} |
| [DRV-003](../details/DRV-003.md) | {{driver_description}} | External / Internal / Regulatory / Strategic | High / Medium / Low | {{notes}} | G-NNN | {{evidence_3}} |
...
|---|---|---|---|---|---|
| [G-001](../details/G-001.md) | {{goal_statement}} | DRV-NNN | STR-NNN | {{owner}} | High / Medium / Low |
| [G-002](../details/G-002.md) | {{goal_statement}} | DRV-NNN | STR-NNN | {{owner}} | High / Medium / Low |
| [G-003](../details/G-003.md) | {{goal_statement}} | DRV-NNN | STR-NNN | {{owner}} | High / Medium / Low |
...
|---|---|---|---|---|---|
| [OBJ-001](../details/OBJ-001.md) | {{objective_statement}} | {{measure}} | {{target_value}} | {{YYYY-MM-DD}} | G-NNN |
| [OBJ-002](../details/OBJ-002.md) | {{objective_statement}} | {{measure}} | {{target_value}} | {{YYYY-MM-DD}} | G-NNN |
| [OBJ-003](../details/OBJ-003.md) | {{objective_statement}} | {{measure}} | {{target_value}} | {{YYYY-MM-DD}} | G-NNN |
...
|---|---|---|---|
| [STR-001](../details/STR-001.md) | {{strategy_statement}} | G-NNN | {{approach}} |
| [STR-002](../details/STR-002.md) | {{strategy_statement}} | G-NNN | {{approach}} |
...
|---|---|---|---|---|---|---|---|
| [ISS-001](../details/ISS-001.md) | Issue | {{issue_statement}} | G-NNN | {{issue_evidence}} | {{issue_raised_by}} | {{owner}} | Open / Being Addressed / Resolved |
| [PRB-001](../details/PRB-001.md) | Problem | {{problem_statement}} | OBJ-NNN | {{problem_evidence}} | {{problem_raised_by}} | {{owner}} | Open / Being Addressed / Resolved |
...
|---|---|---|---|---|---|---|
| [RIS-001](../details/RIS-001.md) | {{risk_description}} | High / Med / Low | High / Med / Low | Critical / High / Med / Low | {{mitigation}} | {{owner}} |
| [RIS-002](../details/RIS-002.md) | {{risk_description}} | High / Med / Low | High / Med / Low | Critical / High / Med / Low | {{mitigation}} | {{owner}} |
| [RIS-003](../details/RIS-003.md) | {{risk_description}} | High / Med / Low | High / Med / Low | Critical / High / Med / Low | {{mitigation}} | {{owner}} |
