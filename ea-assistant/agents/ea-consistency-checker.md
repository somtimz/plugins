...
0. **Load engagement context** — read `EA-projects/{slug}/engagement.json` to identify the current phase, completed phases, and registered artifacts. Use this to scope which artifacts to check and to detect phase-alignment issues.
...
|---|---|---|---|
| phase-a/architecture-vision.md | §15 Key Risks | RIS-007 | "linked to RIS-007 (see Risk Register)" |
