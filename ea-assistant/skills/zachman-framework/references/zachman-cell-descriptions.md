...
This reference describes all 36 cells, with purpose, example content, and example artefacts for each. Each cell also carries an **Expected Model** line — the primitive model that belongs in that cell (one cell = one primitive model; mixing perspectives across rows is an audit finding per `zachman-audit-checklist.md`).
...
**Expected Model:** Business capability list — high-level functions in scope
...
**Expected Model:** Location/site list — regions, sites, business locations
...
**Expected Model:** Organization list — business units and external parties in scope
...
**Expected Model:** Major business events and cycles list
...
**Expected Model:** Goals/objectives list — strategy intent, not detailed motivation modelling
...
**Expected Model:** Conceptual data model — business concepts and relationships
...
**Expected Model:** Business process model — value streams, BPMN L2/L3
...
**Expected Model:** Business logistics/location model — business nodes and connections
...
**Expected Model:** Organization model — roles and responsibilities, business-level RACI
...
**Expected Model:** Business event model — business cycles and event lifecycles
...
**Expected Model:** Business motivation model — ends/means: goals, strategies, policies, rules
...
**Expected Model:** Logical data model — normalised entities and attributes
...
**Expected Model:** Application/function architecture — logical services and use cases
...
**Expected Model:** Logical network/distribution architecture — system nodes and integrations
...
**Expected Model:** Logical identity and access / role model — actors and permissions model
...
**Expected Model:** Logical state/sequence model — state machines, sequence diagrams
...
**Expected Model:** Business rules specification — decision tables, rule catalogue
...
**Expected Model:** Physical data design — schemas, tables, storage structures
...
**Expected Model:** Component design — modules, APIs, programs, microservices design
...
**Expected Model:** Technology network architecture — environments, zones, routing
...
**Expected Model:** Job schedules and orchestration design — batch windows, triggers
...
**Expected Model:** Rule implementation design — rules engines/configs, control design
...
**Expected Model:** DDL / database build scripts — indexes, constraints
...
**Expected Model:** Program specs / code — detailed algorithms
...
**Expected Model:** Network configs — firewalls, DNS, IaC templates
...
**Expected Model:** Security configs — IAM policies, groups, entitlements
...
**Expected Model:** Scheduler configs — cron, pipelines, event triggers
...
**Expected Model:** Policy-as-code / rules tables — configured policies and rules
...
#### Cell 6,1 — Functioning / What (Real Data)
**Purpose:** The actual data instances stored and processed in production systems.
**Expected Model:** Actual data — records in production
**Example Content:** Live customer records, active orders, current inventory counts
**Example Artefacts:** Production database instances, data extracts, operational reports

#### Cell 6,2 — Functioning / How (Running Functions)
**Purpose:** The software and processes as they execute in the live production environment.
**Expected Model:** Running processes and applications
**Example Content:** Order Management System running in production, batch jobs executing nightly
**Example Artefacts:** Deployed application instances, process execution logs, operational runbooks

#### Cell 6,3 — Functioning / Where (Live Network)
**Purpose:** The network and infrastructure as it is actually configured and operating in production.
**Expected Model:** Live network as operated
**Example Content:** Live AWS VPC routing tables, active firewall rules, real CDN edge nodes
**Example Artefacts:** Network configuration backups, infrastructure state files, topology as-built diagrams

#### Cell 6,4 — Functioning / Who (Real People)
**Purpose:** The actual people performing roles in the live system — operators, users, and support staff.
**Expected Model:** Real people executing roles
**Example Content:** Named operators assigned to support shifts, actual user accounts active in the system
**Example Artefacts:** User directories, access provisioning records, support team rosters

#### Cell 6,5 — Functioning / When (Real Events)
**Purpose:** Business and system events as they actually occur — timing, frequency, and performance in production.
**Expected Model:** Actual timing and performance — logs, metrics, SLA results
**Example Content:** Order creation event timestamps, batch job completion times, SLA compliance metrics
**Example Artefacts:** Application logs, monitoring dashboards, SLA reports, incident timelines

#### Cell 6,6 — Functioning / Why (Enacted Goals)
**Purpose:** The enterprise as it actually operates — which goals are being achieved, which strategies are working.
**Expected Model:** Operational outcomes — KPI attainment, actual decisions made
**Example Content:** Current NPS score, revenue vs target, cost reduction achieved vs planned
**Example Artefacts:** KPI dashboards, balanced scorecard results, business performance reports
